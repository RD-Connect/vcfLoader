package steps
    ...
    case class Variant(pos:Int,ref:String,alt:String,rs:String,indel:Boolean,
...
val samples = Samples.select("_1","_2","_3","_4","_5","_6","chrom","band")
...
val effects = Effects.select("chrom","_1","_2","_3","_4","_5","_6","band")
   ...
   val joined= effects.join(samples, effects("_1") === samples("_1") && effects("_2") === samples("_2") && effects("_3") === samples("_3"), "right")
     .map(a => Variant(a(8).toString.toInt,
       a(9).toString,
       a(10).toString,
       a(11).toString,
